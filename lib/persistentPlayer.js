    ...
    playAnnouncementPromise (url, options) {
      ...
      .then(function(){
        if (that.getStatus() === undefined || that.getCurrentPlaylistId() === undefined || that.getStatus().playerState == "IDLE")
          ...
          //Inserted - set a timeout in order to resume playing after the announcement is done at the original position and volume
            ...
            return new Promise(function (resolve, reject) {
              ...
              let resumeAfterAnnouncement = function (status) {
                ...
                (
                  ...
                  (
                    nextItem && that.getCurrentPlaylistId() == nextItem.itemId ||
