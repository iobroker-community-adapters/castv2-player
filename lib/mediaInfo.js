  ...
  class MediaInfo extends EventEmitter {
    ...
    _getIcyConnectionPromise () {
      ...
      return new Promise (function (resolve, reject) {
        try {
          ...
          that._icyConnection = icy.get(con, function (res) { resolve(res); }); 
    ...
    _parseIcyHeaderPromise(res) {
      ...
      if ("content-type" in res.headers)
        ...
        that._contentType = mime.lookup(url);
      ...
      {      
        ...
        return that._parsePlaylistPromise(res, parser);
      }
    ...
    //parse playlist
    _parsePlaylistPromise (res, parser) {
      ...
      return new Promise (function (resolve, reject) {
        ...
        res.on('end', function () {
          ...
          for (let i in playlist) {
            ...
            let url         = playlist[i].file;
            let title       = playlist[i].title ? playlist[i].title : url;
            ...
            if (contentType) {
              ...
              itemPromises.push(
                new Promise(function (resolve, reject) {
                  ...
                  that._addItem(url, contentType, {title: title, artist:artist});
                  resolve();
                })
              );
            }
              ...
              let itemMediaInfo = new MediaInfo(that._name, url);
              itemPromises.push(
